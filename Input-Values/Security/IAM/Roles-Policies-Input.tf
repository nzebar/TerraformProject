...
Role1 = {
    ...
    "attach_policy" = ["true"]
    "policy_name" = ["test1"] #Required
    "policy_path" = [""] #Required
    "policy_description" = ["yuh"]
    "policy_local_path" = [
        "Input-Values\\Security\\IAM\\RBAC\\Security-AccessControl\\Policies\\Admin-Policy-Versions\\FullAccess_AccessManagement_Policy1.0.tf"
        ]
